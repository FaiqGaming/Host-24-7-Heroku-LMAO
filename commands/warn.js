...
module.exports.run = async (client, message, args) => {
  ...
  let warnchannel = message.guild.channels.find(`name`, "💬server▪log💬");
  if(!warnchannel) return message.reply("Couldn't find channel");

  message.channel.send(`${wUser} Has Been Warning By ${message.author} Reason: [${reason} ] Warnings Number: [${warns[wUser.id].warns} Warnings]`);
